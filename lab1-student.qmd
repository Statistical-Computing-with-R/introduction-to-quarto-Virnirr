...
format: 
  html:
    code-fold: true        # Enables code folding for all code chunks
    toc: true              # Adds a table of contents
    theme: united
editor: source
embed-resources: true
execute:
  echo: true       # Always show the source code
  error: false  # Continue rendering even if there are errors
---
...
*This dataset investigates the effect of \_*Vitamin C*\_ on tooth growth in \_*Guinea Pigs*\_.*

*The two supplement delivery methods include OJ (\_orange juice\_) and VC (\_*ascorbic acid*\_).*
...
#|   - "Summary of dose of supplements"
#| fig-align: "center"
...
# t-test for tooth length between two supplement methods in the ToothGrowth dataset.
...
1.  Conclusion Based on the p-value:
    1.  The p-value is 0.06063, which is slightly above the commonly used significance level of 0.05.
    2.  So there is not enough evidence to reject the null hypothesis at the 5% significance level.
    3.  Conclusion: We fail to reject the null hypothesis. The data suggests that there is no statistically significant difference in mean tooth length between OJ and VC supplements.
2.  Interpretation of confidence interval:
    1.  The 95% confidence interval is: \[-0.171, 7.571\]/
    2.  The default confidence level for the t.test() function in R is 95%.
    3.  The confidence interval includes 0 (no difference), which supports the conclusion that the true difference between the groups might be zero.
